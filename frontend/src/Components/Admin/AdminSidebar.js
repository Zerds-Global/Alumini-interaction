  ...
  return (
    ...
    >
      ...
      <Nav className="flex-column p-3 mt-3">
        {[
          { to: "/admin/dash", icon: <FiHome />, label: "Dashboard" },,
          { to: "/admin/job", icon: <FiBook />, label: "Jobs" },
          { to: "/admin/photo", icon: <FiPaperclip />, label: "Photos" },
          { to: "/admin/updates", icon: <FiClipboard />, label: "Updates" },
          { to: "/admin/feedback", icon: <FiCommand/>, label: "Feedback" },
        ].map((item, index) => (
