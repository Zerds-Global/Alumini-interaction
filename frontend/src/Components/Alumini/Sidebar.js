  ...
  return (
    ...
    >
      ...
      <Nav className="flex-column p-3 mt-3">
        {[
          { to: "/alumini/dash", icon: <FiHome />, label: "Dashboard" },
          { to: "/alumini/Manage-job", icon: <FiBriefcase />, label: "Apply Job" },
          { to: "/alumini/photo-gallery", icon: <FiUsers />, label: "Photos" },
          { to: "/alumini/live-updates", icon: <FiBell />, label: "Updates" },
          { to: "/alumini/feedback", icon: <FiUsers />, label: "Feedback" },
        ].map((item, index) => (
