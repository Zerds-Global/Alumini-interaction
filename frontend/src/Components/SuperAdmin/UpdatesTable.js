...
const SuperAdminUpdatesTable = () => {
    ...
    return (
        ...
        >
            ...
            >
                Live Updates Posts - SuperAdmin View
            </h2>
                    ...
                    {filteredUpdates.length > 0 ? (
                        filteredUpdates.map((update, index) => (
                            <tr key={index}>
                                ...
                                <td className="text-center">{update.collegeId?.name || 'N/A'}</td>
...
export default SuperAdminUpdatesTable;
